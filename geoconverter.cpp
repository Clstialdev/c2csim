...
{
    // Given points
    Point p1 = {0, 0, 47.734738, 7.308797};       // Adjust with your actual reference points
    Point p2 = {5000, 3000, 47.762685, 7.374628}; // Adjust with your actual reference points
    Point p3 = {0, 3000, 47.761718, 7.307922};    // Adjust with your actual reference points
    Point p4 = {5000, 0, 47.735700, 7.375457};    // Adjust with your actual reference points
    ...
    double x = (latitude - c) / a;
    double y = (longitude - f) / e;

    // Calculating lat and long for the given x and y
    double convertedLat = a * x + b * y + c;
    double convertedLon = d * x + e * y + f;
